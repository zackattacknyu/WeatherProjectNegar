...
boostArgs.nIter = 1000;  boostArgs.evaliter = unique([1:10:boostArgs.nIter boostArgs.nIter]);
boostArgs.v = 0.1;     boostArgs.funargs = {rf J};
boostStruct=[];
boostStruct = BoostLS(XTrPct, Ytr, XTePct, Yte, @boostTreeFun, boostArgs, [], boostStruct);