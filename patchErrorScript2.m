...
patchesT = cell(1,length(dataFiles));
patchesOld = cell(1,length(dataFiles));
patchesNew = cell(1,length(dataFiles));
predErrorOldMSE = cell(1,length(dataFiles));
predErrorNewMSE = cell(1,length(dataFiles));
predErrorOldEMD = cell(1,length(dataFiles));
predErrorNewEMD = cell(1,length(dataFiles));
